...
newX = np.concatenate([X, X3, X4, X5], axis=1)

X_normalized, mean_vec, std_vec = normalize_features(newX)
...
train_samples = 40
X_train, y_train, X_test, y_test = return_test_set(newX, y, train_samples)
